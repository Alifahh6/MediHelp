...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _openEditProfile() {
    final session = Provider.of<SessionService>(context, listen: false);
    // Isi ulang controller dengan data terbaru dari session
    _nameController.text  = session.userName ?? '';
    _emailController.text = session.userEmail ?? '';
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: _deco(
                        hint: 'Nama lengkap', isDark: isDark, fill: inputFill),
                    validator: (v) =>
                  ...
                  TextFormField(
                    ...
                    decoration:
                    _deco(hint: 'Email', isDark: isDark, fill: inputFill),
                    validator: (v) {
                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        // ✅ PERBAIKAN: panggil session.updateProfile() saat Save
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(success
                                    ...
                                    : 'Gagal mengupdate profil, coba lagi'),
                            ...
                            // Refresh UI agar nama di header ikut berubah
  ...
  Widget _label(String text, Color c) =>
      Text(text,
          style: TextStyle(
              fontSize: 14, fontWeight: FontWeight.w600, color: c));

  InputDecoration _deco(
      {String hint = '', required bool isDark, required Color fill}) =>
      InputDecoration(
        hintText: hint,
        hintStyle: TextStyle(
  ...
  void _showLocationDialog() {
    ...
    showDialog(
      ...
      builder: (_) => Consumer<LocationProvider>(
        builder: (ctx, loc, __) => AlertDialog(
          backgroundColor:
          ...
          title: Row(children: [
            ...
            Text('Lokasi Saya', style: TextStyle(color: textColor))
          ]),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    if (loc.isDefault) ...[
                      ...
                      Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          const SizedBox(width: 6),
                          Text('Menggunakan lokasi default',
                              style: TextStyle(
                                  fontSize: 12,
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SessionService>(builder: (context, session, _) {
              ...
              children: [
                ...
                Text('Anda belum login',
                    style: TextStyle(
                        ...
                        color: textColor)),
                const SizedBox(height: 8),
                Text('Login untuk mengakses profil',
      ...
      final String locationSub = loc.isLoading
          ? 'Mendeteksi...'
          : loc.hasLocation
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Column(children: [
                ...
                const SizedBox(height: 12),
                // ✅ Nama langsung dari session — otomatis update setelah save
            ...
            Padding(
              ...
              child: Column(children: [
                _card(
                  isDark: isDark, bg: cardBg, onTap: _openEditProfile,
                  child: Row(children: [
                    _icon(Icons.edit_outlined),
                ...
                _card(
                  isDark: isDark, bg: cardBg,
                  child: Row(children: [
                    _icon(Icons.notifications_outlined),
                    const SizedBox(width: 14),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                _card(
                  isDark: isDark, bg: cardBg, onTap: _showLocationDialog,
                  child: Row(children: [
